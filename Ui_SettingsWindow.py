...
class Ui_SettingsWindow(object):
    def setupUi(self, SettingsWindow):
        ...
        SettingsWindow.resize(663, 300)
        self.adminInfo_tableWidget = QtWidgets.QTableWidget(SettingsWindow)
        self.adminInfo_tableWidget.setGeometry(QtCore.QRect(10, 40, 341, 192))
        ...
        self.manageAdmin_lbl.setGeometry(QtCore.QRect(30, 10, 141, 16))
        font = QtGui.QFont()
